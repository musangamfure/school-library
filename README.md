...
<p>This project, I built a school library app which allows to add new students or teachers, add new books and save records of who borrowed a given book. I am built this app in practice of my skills on OOP in Ruby.</p>
</div>
...
```sh
  cd my-folder
  git clone git@github.com:musangamfure/school-library.git
```
